...
public:
	...
	Cairo* HasCairo() const;        // Checks if pGameObject is a Cairo Card Then returns it if a card or returns NULL if not
	Aswan* HasAswan() const;
	Hurghada* HasHurghada() const;
	Alexandria* HasAlexandria() const;
	Luxor* HasLuxor() const;
