...
Cairo* Cell::HasCairo() const
{
	return dynamic_cast<Cairo*>(pGameObject);
}

Luxor* Cell::HasLuxor() const
{
	return dynamic_cast<Luxor*>(pGameObject);
}

Alexandria* Cell::HasAlexandria() const
{
	return dynamic_cast<Alexandria*>(pGameObject);
}

Aswan* Cell::HasAswan() const
{
	return dynamic_cast<Aswan*>(pGameObject);
}

Hurghada* Cell::HasHurghada() const
{
	return dynamic_cast<Hurghada*>(pGameObject);
}